...
Оговорка, которую стоит знать до покупки: **EV**-сертификат даёт репутацию
SmartScreen сразу, обычный **OV** — набирает её установками, и первые дни
предупреждение всё равно показывается. Это свойство Windows, а не сборки.
