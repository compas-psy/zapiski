...
export const ru = {
  ...
  settings: {
    ...
    sync: {
      ...
      whereHint:
        'Место одно: заметки либо только на этом устройстве, либо ещё и в одном выбранном хранилище. Переключение ничего не теряет — перед уходом приложение досылает несохранённое',
