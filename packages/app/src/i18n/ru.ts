...
export const ru = {
  ...
  signIn: {
    ...
    consentTerms: 'Принимаю пользовательское соглашение и политику обработки персональных данных',
    consentTermsRequired: 'Без этого согласия аккаунт завести нельзя: аккаунт — это обработка ваших данных',
