...
/**
 * Вернуть как было — стрелка ПРОТИВ часовой.
 *
 * Зеркальная `IconRefresh`, и разница не косметическая: по часовой читается
 * «обновить, повторить», против часовой — «отменить, вернуть». В корзине
 * действие ровно второе.
 */
export const IconRestore = (p: IconProps): ReactNode => (
  <Icon {...p}>
    <path d="M4 12a8 8 0 1 0 2.6-5.9M4 4v4.5h4.5" />
  </Icon>
);
